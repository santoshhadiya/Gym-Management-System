...
const ChatWithOwner = () => {
  const [messages, setMessages] = useState([
    { id: 1, sender: 'trainer', text: 'Good morning, sir!' },
    { id: 2, sender: 'owner', text: 'Morning! Please update me on yesterday’s sessions.' },
  ]);
  ...
  return (
    <div className="max-w-4xl mx-auto mt-6 bg-white p-6 rounded-lg shadow-md flex flex-col h-[80vh]">
      <h1 className="text-2xl font-bold text-red-600 mb-4">Chat with Owner</h1>
